...
def main():
    ...
    with out.open("w", encoding="utf-8", newline="") as f:
        ...
        for r in rows:
            ...
            vals = [float(r[k]) for k in ("lambda_exact","value_gap","left_derivative","right_derivative","derivative_jump","left_curvature","right_curvature")]
    ...
    # The global theorem is intentionally data-driven: reject only an observed
    # positive derivative if the project currently asserts global decrease.
