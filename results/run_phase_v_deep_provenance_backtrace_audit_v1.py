...
lineage=d.get('feature_lineage',[]); n=d['n_features']
assert len(lineage)==n
records=[]
for rec in lineage:
    f=rec['feature']; records.append({'feature':f,'stages':[{'stage':'residual_feature','state':'PRESERVED','identity':f},{'stage':'structural_signature_boundary','state':'LOST','identity':None,'reason':'no_provenance_bound_p_q_r_signature_recovered'}]})
