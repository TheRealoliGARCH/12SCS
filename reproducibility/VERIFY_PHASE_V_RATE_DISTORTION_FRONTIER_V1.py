...
for x in F:
 ...
 assert abs(x['retained_energy']+x['residual_energy']-1)<1e-9; assert x['retained_energy']>=prev_e; assert x['residual_frobenius_norm']<=prev_d
 prev_e=x['retained_energy']; prev_d=x['residual_frobenius_norm']
